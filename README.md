...
-----------------------
This project serves to demonstrate how to collect and tidy up the messy data set that can be used for subsequent analysis. A full description of the data used in this project can be found at The UCI Machine Learning Repository
